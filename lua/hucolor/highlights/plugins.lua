...
M.load = function()
	local plugins = {
		...
		Headline1 = { fg = hucolor.rose, bg = "#362f2d", style = style.bold },
		...
		AerialFunctionIcon = { fg = hucolor.rose },
		AerialInterfaceIcon = { fg = hucolor.blue },
		AerialKeyIcon = { fg = hucolor.blue },
		AerialMethodIcon = { fg = hucolor.rose },
		...
		AerialFunction = { fg = hucolor.rose },
		AerialInterface = { fg = hucolor.blue },
		AerialKey = { fg = hucolor.blue },
		AerialMethod = { fg = hucolor.rose },
		...
		NavicIconsFunction = { fg = hucolor.rose },
		NavicIconsInterface = { fg = hucolor.blue },
		NavicIconsKey = { fg = hucolor.blue },
		NavicIconsMethod = { fg = hucolor.rose },
